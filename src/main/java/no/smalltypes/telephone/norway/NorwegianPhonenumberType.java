...
public enum NorwegianPhonenumberType {
	 ...
	 * @return the enumerated type that best fits the input. If no "real type" can be found, it will return NotAPhoneNumber, which is perfectly valid.
	 */
	public static NorwegianPhonenumberType classify(String terseRepresentation) {
		...
		long numerical = parseLong(normalizedNumber, 10);
		...
		// That's right, in Norway, every ipv4 address could have been hooked to a phone number and you'd still have more than half of them unassigned.
		// Which is kind of cool. You could also allow 100 machines on every normal phone number and still have a lot of free numbers.
